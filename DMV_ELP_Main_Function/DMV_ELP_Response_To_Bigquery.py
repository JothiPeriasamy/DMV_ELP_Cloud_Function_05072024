...
def Insert_Response_to_Bigquery(vAR_df):
   ...
   #  print('vAR_df_access 2 - ',vAR_df["RNN"].to_string(index=False))
    ...
    if 'RNN.MODEL' in vAR_df.columns or 'GPT.MODEL' in vAR_df.columns:
       vAR_query = """Insert into `{}` (REQUEST_ID,REQUEST_DATE,SG_ID,LICENSE_PLATE_CONFIG,LICENSE_PLATE_DESC,DOUBLE_OR_SINGLE,TYPE,LICENSE_PLATE,VIN,ORDER_PLACED_OFFICE_ID,ORDER_DEST_OFFICE_ID,ORDER_NUMBER_CODE,ORDER_GROUP_ID,REGISTERED_OWNER_NAME,REGISTERED_OWNER_ADDRESS,REGISTERED_OWNER_CITY,REGISTERED_OWNER_ZIP,ORDER_PRINTED_DATE,TECH_ID,ORDER_PAYMENT_DATE,PLATE_CODE,BADWORDS_CLASSIFICATION,GUIDELINE_FWORD_CLASSIFICATION,PREVIOUSLY_DENIED_CLASSIFICATION,RULE_BASED_CLASSIFICATION,TOXIC,SEVERE_TOXIC,OBSCENE,IDENTITY_HATE,INSULT,THREAT,OVERALL_SCORE,MODEL,RECOMMENDATION,REASON,ERROR_MESSAGE,CREATED_DT,CREATED_USER,UPDATED_DT,UPDATED_USER,PLATE_TYPE_COUNT,PLATE_TYPE_MAX_COUNT_FLG,RUN_ID,REQUEST_FILE_NAME,TOXIC_REASON,SEVERE_TOXIC_REASON,OBSCENE_REASON,IDENTITY_HATE_REASON,INSULT_REASON,THREAT_REASON,RECOMMENDED_CONFIGURATION,RECOMMENDATION_REASON) values ({},"{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}",parse_date('%m/%d/%E4Y',"{}"),"{}",parse_date('%m/%d/%E4Y',"{}"),"{}","{}","{}","{}","{}",{},{},{},{},{},{},{},"{}","{}","{}","{}","{}","{}","{}","{}",{},{},{},"{}","{}","{}","{}","{}","{}","{}","{}","{}"),  ({},"{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}",parse_date('%m/%d/%E4Y',"{}"),"{}",parse_date('%m/%d/%E4Y',"{}"),"{}","{}","{}","{}","{}",{},{},{},{},{},{},NULL,"{}","{}","{}","{}","{}","{}","{}","{}",{},{},{},"{}","{}","{}","{}","{}","{}","{}","{}","{}")""".format(table,vAR_df.loc[0,'REQUEST_ID'],vAR_df.loc[0,'REQUEST_DATE'],vAR_df.loc[0,'SG_ID'],vAR_df.loc[0,'LICENSE_PLATE_CONFIG'],vAR_df.loc[0,'LICENSE_PLATE_DESC'],vAR_df.loc[0,'DOUBLE_OR_SINGLE'],vAR_df.loc[0,'TYPE'],vAR_df.loc[0,'LICENSE_PLATE'],vAR_df.loc[0,'VIN'],vAR_df.loc[0,'ORDER_PLACED_OFFICE_ID'],vAR_df.loc[0,'ORDER_DEST_OFFICE_ID'],vAR_df.loc[0,'ORDER_NUMBER_CODE'],vAR_df.loc[0,'ORDER_GROUP_ID'],vAR_df.loc[0,'REGISTERED_OWNER_NAME'],vAR_df.loc[0,'REGISTERED_OWNER_ADDRESS'],vAR_df.loc[0,'REGISTERED_OWNER_CITY'],vAR_df.loc[0,'REGISTERED_OWNER_ZIP'],vAR_df.loc[0,'ORDER_PRINTED_DATE'],vAR_df.loc[0,'TECH_ID'],vAR_df.loc[0,'ORDER_PAYMENT_DATE'],vAR_df.loc[0,'PLATE_CODE'],vAR_df.loc[0,'BADWORDS_CLASSIFICATION'],vAR_df.loc[0,'GUIDELINE_FWORD_CLASSIFICATION'],vAR_df.loc[0,'PREVIOUSLY_DENIED_CLASSIFICATION'],vAR_df.loc[0,'RULE_BASED_CLASSIFICATION'],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["TOXIC"],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["SEVERE_TOXIC"],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["OBSCENE"],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["IDENTITY_HATE"],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["INSULT"],vAR_df['RNN.PROFANITY_CLASSIFICATION'][0][0]["THREAT"],vAR_df.loc[0,'RNN.SUM_OF_ALL_CATEGORIES'],vAR_df.loc[0,'RNN.MODEL'],vAR_df.loc[0,'RNN.RECOMMENDATION'],vAR_df.loc[0,'RNN.REASON'],vAR_df.loc[0,'ERROR_MESSAGE'],vAR_df.loc[0,'CREATED_DT'],vAR_df.loc[0,'CREATED_USER'],vAR_df.loc[0,'UPDATED_DT'],vAR_df.loc[0,'UPDATED_USER'],vAR_df.loc[0,'PLATE_TYPE_COUNT'],vAR_df.loc[0,'PLATE_TYPE_MAX_COUNT_FLG'],vAR_df.loc[0,'RUN_ID'],vAR_df.loc[0,'REQUEST_FILE_NAME'],vAR_df.loc[0,'RNN.TOXIC_REASON'],vAR_df.loc[0,'RNN.SEVERE_TOXIC_REASON'],vAR_df.loc[0,'RNN.OBSCENE_REASON'],vAR_df.loc[0,'RNN.IDENTITY_HATE_REASON'],vAR_df.loc[0,'RNN.INSULT_REASON'],vAR_df.loc[0,'RNN.THREAT_REASON'],vAR_df.loc[0,'RNN.RECOMMENDED_CONFIGURATION'],vAR_df.loc[0,'RNN.RECOMMENDATION_REASON'],vAR_df.loc[0,'REQUEST_ID'],vAR_df.loc[0,'REQUEST_DATE'],vAR_df.loc[0,'SG_ID'],vAR_df.loc[0,'LICENSE_PLATE_CONFIG'],vAR_df.loc[0,'LICENSE_PLATE_DESC'],vAR_df.loc[0,'DOUBLE_OR_SINGLE'],vAR_df.loc[0,'TYPE'],vAR_df.loc[0,'LICENSE_PLATE'],vAR_df.loc[0,'VIN'],vAR_df.loc[0,'ORDER_PLACED_OFFICE_ID'],vAR_df.loc[0,'ORDER_DEST_OFFICE_ID'],vAR_df.loc[0,'ORDER_NUMBER_CODE'],vAR_df.loc[0,'ORDER_GROUP_ID'],vAR_df.loc[0,'REGISTERED_OWNER_NAME'],vAR_df.loc[0,'REGISTERED_OWNER_ADDRESS'],vAR_df.loc[0,'REGISTERED_OWNER_CITY'],vAR_df.loc[0,'REGISTERED_OWNER_ZIP'],vAR_df.loc[0,'ORDER_PRINTED_DATE'],vAR_df.loc[0,'TECH_ID'],vAR_df.loc[0,'ORDER_PAYMENT_DATE'],vAR_df.loc[0,'PLATE_CODE'],vAR_df.loc[0,'BADWORDS_CLASSIFICATION'],vAR_df.loc[0,'GUIDELINE_FWORD_CLASSIFICATION'],vAR_df.loc[0,'PREVIOUSLY_DENIED_CLASSIFICATION'],vAR_df.loc[0,'RULE_BASED_CLASSIFICATION'],vAR_df.loc[0,'GPT.TOXIC'],vAR_df.loc[0,'GPT.SEVERE_TOXIC'],vAR_df.loc[0,'GPT.OBSCENE'],vAR_df.loc[0,'GPT.IDENTITY_HATE'],vAR_df.loc[0,'GPT.INSULT'],vAR_df.loc[0,'GPT.THREAT'],vAR_df.loc[0,'GPT.MODEL'],vAR_df.loc[0,'GPT.RECOMMENDATION'],vAR_df.loc[0,'GPT.REASON'],vAR_df.loc[0,'ERROR_MESSAGE'],vAR_df.loc[0,'CREATED_DT'],vAR_df.loc[0,'CREATED_USER'],vAR_df.loc[0,'UPDATED_DT'],vAR_df.loc[0,'UPDATED_USER'],vAR_df.loc[0,'PLATE_TYPE_COUNT'],vAR_df.loc[0,'PLATE_TYPE_MAX_COUNT_FLG'],vAR_df.loc[0,'RUN_ID'],vAR_df.loc[0,'REQUEST_FILE_NAME'],vAR_df.loc[0,'GPT.TOXIC_REASON'],vAR_df.loc[0,'GPT.SEVERE_TOXIC_REASON'],vAR_df.loc[0,'GPT.OBSCENE_REASON'],vAR_df.loc[0,'GPT.HATE_REASON'],vAR_df.loc[0,'GPT.INSULT_REASON'],vAR_df.loc[0,'GPT.THREAT_REASON'],vAR_df.loc[0,'GPT.RECOMMENDED_CONFIGURATION'],vAR_df.loc[0,'GPT.RECOMMENDATION_REASON'])
...
FROM (
  ...
  WHERE
    MODEL IS NULL AND RUN_ID=(select max(RUN_ID) from `{}.{}.{}` where date(created_dt)=current_date())
  UNION ALL
  SELECT
    *
  FROM (
...
""".format(os.environ["GCP_PROJECT_ID"],os.environ["GCP_BQ_SCHEMA_NAME"],vAR_response_table_name,os.environ["GCP_PROJECT_ID"],os.environ["GCP_BQ_SCHEMA_NAME"],vAR_response_table_name,os.environ["GCP_PROJECT_ID"],os.environ["GCP_BQ_SCHEMA_NAME"],vAR_response_table_name,os.environ["GCP_PROJECT_ID"],os.environ["GCP_BQ_SCHEMA_NAME"],vAR_response_table_name)
    )
