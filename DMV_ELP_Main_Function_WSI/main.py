...
def Process_ELP_Orders(request):
   ...
   try:
      ...
      with blob.open(mode='w') as f:
         try:
            ...
            if vAR_current_date_request_count==0:
               ...
               vAR_batch_elp_configuration_raw = pd.read_csv(vAR_s3_url)
      ...
      print("Error occured in start - ",str(e))
      print('Error Traceback - '+str(traceback.print_exc()))
...
def PreProcessRequest(vAR_batch_elp_configuration_raw,vAR_s3_url):
   ...
   if 'Unnamed: 0' in vAR_batch_elp_configuration_raw:
      vAR_batch_elp_configuration_raw = vAR_batch_elp_configuration_raw.drop(['Unnamed: 0'],axis=1)
   ...
   vAR_batch_elp_configuration_raw.rename(columns = {'Config':'LICENSE_PLATE_CONFIG'}, inplace = True)
