...
def Upload_Response_To_S3(vAR_result,vAR_s3_request_file_name):
   try:
      ...
      vAR_s3_resource.Object(vAR_bucket_name, os.environ["AWS_RESPONSE_PATH"]+'/'+'response_'+vAR_s3_request_file_name+'.csv').put(Body=vAR_csv_buffer.getvalue())
      print('bucket - ',vAR_bucket_name)
      vAR_response_path = os.environ["AWS_RESPONSE_PATH"]+'/'+'response_'+vAR_s3_request_file_name+'.csv' 
